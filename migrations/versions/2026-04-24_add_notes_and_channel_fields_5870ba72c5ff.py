"""Add notes and channel fields

Revision ID: 5870ba72c5ff
Revises: ab8ba13ef69f
Create Date: 2026-04-24 11:39:25.976912
...
revision = '5870ba72c5ff'
down_revision = 'ab8ba13ef69f'
branch_labels = None
depends_on = None
...
def schema_upgrades() -> None:
    ...
    with op.batch_alter_table('show', schema=None) as batch_op:
        batch_op.add_column(sa.Column('user_channel', sa.String(length=50), nullable=True))
...
def schema_downgrades() -> None:
    ...
    with op.batch_alter_table('show', schema=None) as batch_op:
        ...
        batch_op.drop_column('user_channel')
